    ...
    >
      <header id="header">
        <div id="logoContainer">
          <img src={require('../assets/ALU-logo-white-full.png')} alt="logo" id="logo" />
        </div>
        <a
      ...
      <main id="body">
        ...
        <ul>
          ...
          <li>
            ...
            Desktop for Windows, Linux or Mac, and run it. If you are using Windows, make sure you
            have enabled{' '}
            <a
          ...
          <li>
            Run docker-compose up --build to start the containers. This will take a few minutes the
            first time you run it.
          </li>
          <li>Run npm start to start the development server. The server will run on port 8080.</li>
          <li>
            Check the list of{' '}
            <a
            ...
            on github and pick one to work on (Be sure to communicate it through a comment). If you
            have any questions, contact the repo organiser (Dirac156).
          </li>
        </ul>
