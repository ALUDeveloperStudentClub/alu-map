...
const Contributors = () => {
    ...
    >
      ...
      <main id="body">
        ...
        <ul>
          <li>
            If you haven't already run, npm install to install node modules
          </li>
          <li>
            Install{" "}
            <a
            ...
            Desktop for Windows, Linux or Mac, and run it. If you are using
          ...
          <li>
            Run docker-compose up --build to start the containers. This will
            take a few minutes the first time you run it.
          </li>
          <li>
            Run npm start to start the development server. The server will run
            on port 8080.
          </li>
          <li>
            Check the list of{" "}
            ...
            on github and pick one to work on (Be sure to communicate it through
            a comment). If you have any questions, contact the repo organiser
            (Dirac156).
          </li>
        </ul>
